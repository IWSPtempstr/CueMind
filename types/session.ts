...
import type { ContextSummaryRecord } from "@/lib/realtime-context-memory";
...
export interface SessionSnapshot {
  id: string;
  title: string;
  /** Browser-kept raw access token for session-scoped API calls; never persisted server-side. */
